...
class UnpooledDataSourceTest {
    ...
    void shouldRegisterDynamicallyLoadedDriver() throws Exception {
        ...
        UnpooledDataSource dataSource = null;
        driverClassLoader = new URLClassLoader(new URL[]{new URL("jar:file:/PATH_TO/mysql-connector-java-5" +
                ".1.25.jar!/")});
        dataSource = new UnpooledDataSource(driverClassLoader, "com.mysql.jdbc.Driver", "jdbc:mysql://127.0" +
                ".0.1/test", "root", "");
        dataSource.getConnection().close();
