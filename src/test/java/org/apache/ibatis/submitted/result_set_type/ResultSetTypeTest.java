...
class ResultSetTypeTest {
    ...
    static void setUp() throws Exception {
        ...
        try (Reader reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/result_set_type" +
                "/mybatis-config.xml")) {
        ...
        ScriptRunner runner =
                new ScriptRunner(sqlSessionFactory.getConfiguration().getEnvironment().getDataSource().getConnection());
