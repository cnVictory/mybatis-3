...
public enum AutoMappingUnknownColumnBehavior {
    ...
    /**
     * Output warning log.
     * Note: The log level of {@code 'org.apache.ibatis.session.AutoMappingUnknownColumnBehavior'} must be
     * set to {@code WARN}.
     */
    WARNING {
        @Override
    ...
    private static String buildMessage(MappedStatement mappedStatement, String columnName, String property,
        ...
        return new StringBuilder("Unknown column is detected on '")
                ...
                .append(",").append("propertyType=").append(propertyType != null ? propertyType.getName() :
                        null)
                .append("]")
                .toString();
    }
    ...
    /**
     * Perform the action when detects an unknown column (or unknown property type) of automatic mapping
     * target.
     *
     ...
     * {@link org.apache.ibatis.type.TypeHandler} for property type is not registered)
     */
