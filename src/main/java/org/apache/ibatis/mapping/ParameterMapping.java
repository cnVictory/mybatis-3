        ...
        private void validate() {
            if (ResultSet.class.equals(parameterMapping.javaType)) {
                ...
                if (parameterMapping.typeHandler == null) {
                    throw new IllegalStateException("Type handler was null on parameter mapping for " +
                            "property '"
                            + parameterMapping.property + "'. It was either not specified and/or could not " +
                            "be found for the javaType ("
